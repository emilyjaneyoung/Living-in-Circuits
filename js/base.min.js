...
function animate(){$(".fade").velocity({opacity:0},0).velocity({opacity:1},{duration:1e3,delay:1500}),$(".path").velocity({"stroke-dashoffset":3e3},0).velocity({"stroke-dashoffset":0},{duration:1e3,delay:500}),$(".lights-1").velocity({fillRed:255,fillGreen:255,fillBlue:102},{duration:500,delay:4e3}),$(".lights-2").velocity({fillRed:255,fillGreen:255,fillBlue:102},{duration:500,delay:4500}),$(".lights-3").velocity({fillRed:255,fillGreen:255,fillBlue:102},{duration:500,delay:5e3})}animate(),$(".content .post__content").readingTime(),$(function(){$("#infinite-scroll-wrap").infinitescroll({navSelector:".pagination",nextSelector:".next-page",itemSelector:".square__item",loadingImg:"",animate:!0,maxPage:parseInt($(".next-page").data("pages")),behavior:"twitter"}),$(window).unbind(".infscr"),$(".next-page").click(function(){return $(document).trigger("retrieve.infscr"),!1}),$(document).ajaxError(function(e,t,i){404==t.status&&$(".next-page").remove()})});